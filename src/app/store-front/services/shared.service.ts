...
export class SharedService {
  ...
  private cliente = new BehaviorSubject<ClienteProv|null>(null);
  ...
  clienteFactura$ = this.cliente.asObservable();
  ...
  updateClienteFactura(valor2: ClienteProv) {this.cliente.next(valor2);}
  ...
  updatefacturaActiva(valor2: Venta) {this.facturaActiva.next(valor2);}
