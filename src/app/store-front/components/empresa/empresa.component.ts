...
import { Empresa } from '../interfaces/empresa.interface';
 ...
 export class EmpresaComponent {
    ...
    public elementNodeId! : string | null;
    ...
    //Collection of data
    public data1: object[] = [
     { Name: this.miEmpresa ? this.miEmpresa.nombre:'', Id: "1", hasChild: true, expanded: true },
     { Name: "Sucursal: ", Id: "2", ParentId: "1", hasChild: true, expanded: true },
     { Name: "Caja Principal", Id: "3", ParentId: "2", hasChild: true, expanded: true },
     { Name: "Caja 2", Id: "4", ParentId: "2", hasChild: true, expanded: true },
     { Name: "Usuario: ", Id: "5", ParentId: "3", hasChild: true, expanded: true },
    ];
     ...
     let diagram = this.diagram;
       setTimeout(() => {
          ...
          if (args.element.inEdges.length === 0) {
              ...
              this.treeview.addNodes([item], this.targetNodeId, undefined);
...
//Change the annotation of the node
 ...
 public removeSubChild(node:any, canDelete:any) {
     let childNode:any;
     let connector:any;
