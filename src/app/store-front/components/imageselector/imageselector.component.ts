 ...
 */
 ...
 @Component({
    selector: 'image-selector-component',
 ...
 export class ImageSelectorComponent {
    @ViewChild('Dialog')
    public DialogInstance!: DialogComponent | null;
    ...
    public imageLoaded = (): void => {
        if (this.imgSrc === '') {
            ...
            let image: any = document.querySelector('#demo-img');
    ...
    public dialogOpen = (): void => {
        const img: any = document.querySelector('#demo-img');
    ...
    public imageChanged = (args: any): void=> {
        ...
        (document.getElementById('img-upload') as any).value = null;
    ...
    public dlgDoneBtnClick = (): void => {
        ...
        const canvas: any = document.querySelector('#img-canvas');
        const ctx: CanvasRenderingContext2D = canvas.getContext('2d');
        const parentDiv: any = document.querySelector('.e-profile');
